...
{   	
   ...
   //print '<th>Account No.<th>Start Date<th>Expire Date<th>';

       print '<table>';
       print '<th style="width:300px">Account No.
    			<th style="width:300px">Start Date
    			<th style="width:100px">Expire Date';
...
switch ($action) {
	...
	$query="INSERT INTO nwc_membership VALUES ('$membershipAccount','$membershipStart','$membershipEnd')";
	break;
	...
	$query="UPDATE nwc_membership
		SET account_no = '$membershipNewAccount',start_date = '$membershipNewStart',expire_date = '$membershipNewEnd'
		WHERE account_no = '$membershipAccount'";
}
mysql_query($query);
